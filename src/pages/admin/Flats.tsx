...
export default function Flats() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const flatData: any = {
      ...
      booked_status: editingFlat ? editingFlat.booked_status : 'Not Booked',
      ...
      <div className="space-y-6 px-2 sm:px-6 md:px-8 lg:px-10 xl:px-16">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-muted-foreground">Manage your flat inventory.</p>
          </div>
          <Dialog open={dialogOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Helper note for new flats */}
                {!editingFlat && (
                  <p className="text-sm text-muted-foreground bg-muted p-3 rounded-md">
                    💡 Flats can be booked later from the <strong>Bookings</strong> page.
                  </p>
                )}
